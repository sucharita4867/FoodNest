...
const Banner = () => {
  return (
    <section className="bg-gradient-to-r rounded from-orange-50 to-orange-100 dark:from-gray-900 dark:to-gray-800 min-h-[80vh] flex items-center">
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 dark:text-white leading-tight">
            Welcome to <span className="text-orange-500">FoodNest</span>
          </h1>
